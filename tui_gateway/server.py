...
from . import (  # noqa: E402
    ...
    methods_projects as _methods_projects, methods_free_tier as _methods_free_tier)
...
for _m in (
    ...
    _methods_bot_relay, _prompt_turn, _billing_view, _methods_projects, _methods_free_tier):
