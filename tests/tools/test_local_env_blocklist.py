    ...
    def test_execute_code_composition_strips_inherited_hermes_entries(self, same_env, request):
        ...
        * user entries survive after the controlled entries.
        ...
        def _fake_popen(cmd, **kwargs):
            ...
            proc = MagicMock()
            # Real byte streams preserve the fork's fixture fidelity and return EOF from both read() and read1(),
            # preventing upstream's reader-thread spin/leak regression.
