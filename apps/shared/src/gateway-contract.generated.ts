...
/** ``methods_session.dashboard.new_session_requested`` — a hosted TUI asked the dashboard for a fresh chat (dashboard owns the embedded PTY lifecycle). */
export interface DashboardNewSessionRequestedPayload {
  reason?: string
}
...
export interface BackendGatewayEventMap {
  ...
  /** Terminal state of one approval request (request-scoped, not a client answer). */
  ...
  /** A hosted TUI asked the dashboard for a fresh chat. */
  'dashboard.new_session_requested': DashboardNewSessionRequestedPayload
  ...
  /** A child's reasoning chunk (fork alias of subagent.thinking, relayed as reasoning.delta). */
