...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_loop_slash(self, tree) -> None:
        ...
        @discord.app_commands.describe(
            ...
            times="Stop after this many runs (0 = configured safety budget)",
        ...
        async def slash_loop(
            interaction: discord.Interaction, action: str = "status", prompt: str = "",
            every: str = "", times: int = 0, until: str = "",
        ):
    ...
    def _register_slash_commands(self) -> None:
        ...
        if not self._client:
            return
        tree = self._client.tree
        self._register_loop_slash(tree)
