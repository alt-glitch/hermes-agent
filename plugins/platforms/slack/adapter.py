...
try:  # sibling module; support both package and flat plugin-dir import
    ...
    from .model_picker import SlackModelPicker
except ImportError:  # pragma: no cover - plugin loaded outside package context
    from block_kit import render_blocks, sanitize_blocks  # type: ignore
    from model_picker import SlackModelPicker  # type: ignore
...
class SlackAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._model_picker = SlackModelPicker(self)
    ...
    def _register_bolt_handlers(self) -> None:
        ...
        self._model_picker.register(self._app)
