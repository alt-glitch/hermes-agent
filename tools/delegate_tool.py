...
def _run_single_child(
    ...
    * ``"completed"``       — normal finish. See #97655.
    ...
    # child works; once the child looks stale (see _HEARTBEAT_STALE_CYCLES_*) it also ends await_child's wait, whose
    # abandonment path interrupts the stalled child.
