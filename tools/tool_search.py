...
def resolve_underlying_call(args: Dict[str, Any]) -> Tuple[Optional[str], Dict[str, Any], Optional[str]]:
    ...
    * the trajectory recorder.
    ...
    # Fork-owned deferred batching permits ordered local, connector, and mixed entries; the
    # connector dispatch sibling applies each entry's own scope, schema, middleware, and policy.
