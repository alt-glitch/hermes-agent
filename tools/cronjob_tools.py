...
def _claim_for_manual_run(job_id: str, log_label: str):
    ...
    try:
        ...
        claimed_job = claim_job_for_fire(
            job_id, manual=True, return_job=True, respect_local_running=True)
...
def _action_create(a: Dict[str, Any]) -> str:
    ...
    try:
        job = create_job_with_scheduler_registration(
            ...
            inactivity_timeout_seconds=a["inactivity_timeout_seconds"],
...
def _update_run_fields(job: Dict[str, Any], a: Dict[str, Any], updates: Dict[str, Any]) -> Optional[str]:
    ...
    if a["inactivity_timeout_seconds"] is not None:
        updates["inactivity_timeout_seconds"] = a["inactivity_timeout_seconds"]
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "inactivity_timeout_seconds": {
                ...
                "description": "Per-job inactivity watchdog in seconds. Use 0 for unlimited; omit to inherit the global cron timeout. On update, inherit resets to global.",
            },
            "attach_to_session": {
                "type": "boolean",
...
_HANDLER_FORWARDED_ARGS = (
    ...
    "inactivity_timeout_seconds", "paused_reason", "all", "pinned")
