...
def build_cron_parser(subparsers, *, cmd_cron: Callable) -> None:
    ...
    cron_create.add_argument("--inactivity-timeout", dest="inactivity_timeout_seconds",
        help="Per-job agent inactivity watchdog in seconds. Use 0 for unlimited; "
            "omit to inherit the global cron timeout.")
    cron_create.add_argument(
    ...
    cron_edit.add_argument("--inactivity-timeout", dest="inactivity_timeout_seconds",
        help="Per-job agent inactivity watchdog in seconds. Use 0 for unlimited or "
            "'inherit' to reset to the global cron timeout.")
