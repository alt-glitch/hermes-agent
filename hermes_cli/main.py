...
from hermes_cli.main_tui_launch import (
    ...
    _config_tui_engine_early,
    _config_tui_heap_mb_early,
    _ensure_tui_node,
    _launch_tui,
    _make_opentui_argv,
    _make_tui_argv,
    ...
    _opentui_available,
    _opentui_runtime,
    _opentui_runtime_state_dir,
    _print_tui_exit_summary,
    _tui_active_session_file_is_detached,
    _pin_kanban_board_env,
    _read_cgroup_memory_limit,
    _resolve_tui_engine,
    _resolve_tui_heap_mb,
    _resolve_tui_heap_override,
    _resolve_use_tui,
...
def _resolve_chat_session_args(args, use_tui: bool) -> None:
    ...
    if (
        getattr(args, "resume", None) is not True
