...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        # A bare update follows the checkout's current branch when that branch
        # exists on origin. Preserve the older local-only-branch safety net:
        # if the current branch has no remote counterpart, update main instead
        # of feeding a missing ref to rev-list. An explicit --branch must never
...
_is_android_python = _update_cmd._is_android_python
_install_psutil_android_compat = _update_cmd._install_psutil_android_compat
_ensure_uv_for_termux = _update_cmd._ensure_uv_for_termux
_npm_manifest_paths = _update_cmd._npm_manifest_paths
...
_update_cmd._update_node_dependencies = _update_node_dependencies
_cmd_update_impl = _update_cmd._cmd_update_impl
